/**
 * EDC Energy Meter Payload Decoder for Chirpstack V4
 * 
 * This decoder handles TLV (Type-Length-Value) encoded payloads from 
 * the EDC LoRaWAN energy meter.
 * 
 * Chirpstack V4 uses a different codec interface than V3.
 * 
 * @param {Object} input - Input object from Chirpstack
 * @param {Uint8Array} input.bytes - Raw payload bytes
 * @param {number} input.fPort - LoRaWAN port number
 * @param {Object} input.variables - Device variables (if any)
 * @returns {Object} Decoded payload object with 'data' key
 */
...
/**
 * Encode downlink command for Chirpstack V4
 * 
 * @param {Object} input - Input object from Chirpstack
